...
try:
    ...
    words_translations = pd.read_csv("data/swedish_words.csv")
    to_learn = words_translations.to_dict(orient="records")
else:
...
def next_card():
    ...
    canvas.itemconfig(card_text, text=current_card["Swedish"], fill="black")
...
card_text = canvas.create_text(400, 263, text="", font=(FONT_NAME, 40, "bold"))
